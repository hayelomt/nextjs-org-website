...
const VideoCard = ({ tag, title, date, link }: VideoProps) => (
  <motion.article
  ...
  >
    <div
      className="h-[337px] w-full bg-cover bg-center rounded-[24px] relative sm:rounded-[32px] overflow-hidden"
      style={{}}
    >
      <iframe className="w-full h-full object-cover" src={link}></iframe>
