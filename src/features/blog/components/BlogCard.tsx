  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `url("${ImageUtils.getMediaUrl(blog.media[0])}")`,
        }}
      ></div>
      <div className="py-[22px] sm:py-[32px] px-[18px] sm:px-[27px] flex flex-col pb-[40px]">
        ...
        <h3 className="mb-2 text-dark-text line-clamp-2">{blog.title}</h3>
      ...
      <div className="flex items-center absolute bottom-[22px] sm:bottom-[32px] left-[18px] sm:left-[27px]">
        ...
        <p className="subtitle text-light-text">{blog.date}</p>
      </div>
    </motion.article>
  );
};
